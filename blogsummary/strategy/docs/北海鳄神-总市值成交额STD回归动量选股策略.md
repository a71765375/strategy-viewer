...
| 指标 | 值 |
|------|-----|
| 年化收益 | <span class="hljs-subst">{annual_return:<span class="hljs-number">.2</span>f}</span>% |
| 最大回撤 | <span class="hljs-subst">{max_drawdown:<span class="hljs-number">.2</span>f}</span>% |
